...
sealed class Routes(val route: String, val title: String, val icon: ImageVector) {
    ...
    object BreathingExercise : Routes("breathing_exercise", "Ejercicio", Icons.Default.Home)
    object Meditation : Routes("meditation", "Meditación", Icons.Default.Home)
    object MeditationExercise : Routes("meditation_exercise", "Meditación", Icons.Default.Home)
